...
function updateDisplay() {
  ...
  accountsData.forEach((account, index) => {
    ...
    console.log(`AKUN ${index + 1}:     | ${account.email.padEnd(25)} | ${currentTime.padEnd(10)} | ${pointsToday.padEnd(11)} | ${pointsTotal.padEnd(12)} | ${proxyStatus.padEnd(8)} | ${pingStatus.padEnd(10)} | ${elapsedTime.padEnd(10)} | ${websocketStatus.padEnd(10)} | @AirdropJP_JawaPride`);
  });
