...
function updateDisplay() {
  ...
  accountsData.forEach((account, index) => {
    ...
    if (index % 2 === 0) {
      ...
      leftColumn.push(`TELEGRAM   : @AirdropJP_JawaPride`.padEnd(40)); // Memperbaiki baris ini
      leftColumn.push('--------------------------------------------------------------------------------');
    } else {
      rightColumn.push('---------------------------------------------------------------------------------');
      ...
      rightColumn.push(`TELEGRAM   : @AirdropJP_JawaPride`.padEnd(40)); // Memperbaiki baris ini
      rightColumn.push('---------------------------------------------------------------------------------');
    }
  });
